function initCanvas(){
    ...
    function Launcher(){
        ...
        this.render = function () {
            ...
            if (enemies.length === 0) {
                ...
                ctx.fillText('You win! Press P to restart', cW * .5 - 180, 50);
            }
        }
        ...
        this.hitDetectLowerLevel = function(enemy){
            if(enemy.y > 550){
                ...
                this.gameStatus.message = 'Enemy(s) have passed! Press P to restart';
            }
            ...
            if(this.gameStatus.over === true){
                ...
                ctx.font = this.gameStatus.font;
                ctx.fillText(this.gameStatus.message, cW * .5 - 180, 50);
            }
        }
    }
    ...
    // Show initial screen with commands
    function showInitialScreen() {
        ctx.fillStyle = "black";
        ctx.fillRect(0, 0, cW, cH);
        ctx.fillStyle = "white";
        ctx.font = "bold 24px Arial";
        ctx.fillText("Welcome to the Space Game!", cW / 2 - 150, cH / 2 - 80);
        ctx.fillText("Use arrow keys to move the spaceship", cW / 2 - 200, cH / 2 - 40);
        ctx.fillText("Press SPACE to shoot", cW / 2 - 150, cH / 2);
        ctx.fillText("Press P to restart the game", cW / 2 - 180, cH / 2 + 40);
        ctx.fillText("Press ENTER to start the game", cW / 2 - 180, cH / 2 + 80);
